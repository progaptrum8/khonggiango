    ...
    var Mark = function () {
        ...
        _createClass(Mark, [{
            ...
            value: function createDiacriticsRegExp(str) {
            	var dct = ["aÀÁẠẢÃÂẦẤẬẨẪĂẰẮẶẲẴàáạảãâầấậẩẫăằắặẳẵ", "cÇçćĆčČ", "dđĐďĎ", "eÈÉẸẺẼÊỀẾỆỂỄèéẹẻẽêềếệểễ", "iÌÍỊỈĨìíịỉĩ", "lłŁ", "nÑñňŇńŃ", "oÒÓỌỎÕÔỒỐỘỔỖƠỜỚỢỞỠòóọỏõôồốộổỗơờớợởỡ", "rřŘ", "sŠšśŚ", "tťŤ", "uÙÚỤỦŨƯỪỨỰỬỮùúụủũưừứựửữ", "yỲÝỴỶỸỳýỵỷỹ", "zŽžżŻźŹ"];
                var handled = [];
