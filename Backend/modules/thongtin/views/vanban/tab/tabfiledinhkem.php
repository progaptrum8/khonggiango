                ...
                if (count($fileDinhKem)>0) {
                    ...
                    foreach ($fileDinhKem as $rows) {
                        ...
                        <tr>
                            ...
                            <td class="text-center"><?=$rows->nguoiTao->fullname?></td>
                    ...
                    ?>
                        <tr>
                            <td class="text-center" colspan="4">Không có file đính kèm</td>                            
                        </tr>
                    <?php
                }
                ?>
                <tr>
                    <td class="text-center" colspan="4"><input id="fileUpload" name="fileUpload" class="form-control" data-id="<?= $idObject ?>" type="file" /></td>
                </tr>
            </tbody>
        </table>
    </div>
