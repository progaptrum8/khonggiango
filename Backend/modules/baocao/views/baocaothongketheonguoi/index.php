    ...
    <section class="content">
        <div class="box box-default">
            <div class="box-header with-border">
                <?= Html::beginForm(["/baocao/baocaothongketheonguoi/showview"], 'post', ['id' => 'formBaoCao','name' =>'formBaoCao','enctype' => 'multipart/form-data']) ?>
                <div class="row ">	 
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">                            
                            <label class="control-label">Người tiếp nhận</label>
                            <select id="selectCoQuan" class="form-control" name="selectNguoiTiepNhan">
                                    <?php foreach ($listNguoiTiepNhan as $itemNguoiTiepNhan) { ?>
                                        <option value="<?= $itemNguoiTiepNhan->id ?>"><?= $itemNguoiTiepNhan->fullname ?></option> 
                                    <?php }?>                                
                            </select>
                        </div>
                    </div>
