    ...
    <section class="content">
        <div class="box box-default">
            <div class="box-header with-border">
                <?= Html::beginForm(["/baocao/baocaothongke/showview"], 'post', ['id' => 'formBaoCao','name' =>'formBaoCao','enctype' => 'multipart/form-data']) ?>
                <div class="row ">	 
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">                            
                            ...
                            <select id="selectCoQuan" class="form-control" name="selectCoQuan[]" multiple="true">                                
                    ...
                    <div class="col-md-12">
                        <div class="form-group">                            
                            ...
                            <select id="selectLoaiVanBan" class="form-control" name="selectLoaiVanBan[]" multiple="true">                                
                                    <option value="0" selected="selected">--Tất cả loại văn bản--</option>
                                    <?php foreach ($listLVB as $itemLVB) { ?>
                                        <option value="<?= $itemLVB->idLVB ?>"><?= $itemLVB->name ?></option> 
                                    <?php }?>                                
                            </select>
                        </div>
                    </div>
