...
<table border=0 cellpadding=0 cellspacing=0 width=1313 style='border-collapse:
 collapse;table-layout:fixed;width:986pt'>
 ...
 <tr height=27 style='height:20.25pt'>
  <td colspan=11 height=27 class=xl73 style='height:20.25pt'>BÁO CÁO THỐNG KÊ
  TỔNG HỢP</td>
 </tr>
 <tr height=20 style='height:15.0pt'>
  <td colspan=11 height=20 class=xl74 style='height:15.0pt'>(Từ ngày <?=$tuNgay?> đến ngày <?=$denNgay?>)</td>
 </tr>
 <tr height=20 style='height:15.0pt'>
  <td height=20 class=xl65 style='height:15.0pt'></td>
  <td class=xl65></td>
 ...
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  <td rowspan=2 height=58 class=xl75 width=64 style='border-bottom:.5pt solid black;
  height:43.5pt;width:48pt'>STT</td>
  <td colspan=9 class=xl78 width=1185 style='border-right:.5pt solid black;
  border-left:none;width:890pt'>Văn bản</td>
  <td rowspan=2 class=xl75 width=64 style='border-bottom:.5pt solid black;
  width:48pt'>Ghi chú</td>
 </tr>
 <tr height=38 style='height:28.5pt'>
  <td height=38 class=xl67 width=116 style='height:28.5pt;width:87pt'>Số ký
  hiệu</td>
  ...
  <td class=xl68 width=68 style='width:51pt'>Ngày tiếp nhận</td>
...
foreach($data as $item){
    $item = app\models\VbVanban::findOne($item);
?>
 <tr height=40 style='height:30.0pt'>
  <td height=40 class=xl69 width=64 style='height:30.0pt;width:48pt'><?=$i++?></td>
  ...
  <td class=xl71 width=68 style='width:51pt'><?=Common::dateUSToVNDate($item->ngayTiepNhan)?></td>
