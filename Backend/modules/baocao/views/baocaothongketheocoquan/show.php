...
?>
<?= Html::beginForm(['/baocao/baocaothongketheocoquan/showview'], 'post',['id' => 'formShowviewReport','name' => 'formShowviewReport']) ?>                
<!-- Main content -->
<style>
    .col-md-5{
        width: 40%;
...
<input type="hidden" name="selectCoQuan" value="<?=$selectCoQuan?>" />
<?=Html::endForm() ?>
<p id="lasttext"></p>
<script type="text/javascript">
    ...
    function pageClick(page){
        document.formShowviewReport.action = '/baocao/baocaothongketheocoquan/showview?page='+(page+1);
        document.formShowviewReport.submit();
    }    
    function submitForm(){
        document.formShowviewReport.action = '/baocao/baocaothongketheocoquan/showview';
        document.formShowviewReport.submit();
    }
</script>