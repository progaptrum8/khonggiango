...
<div class="listDanhMuc">
    <section class="content-header">
        ...
        <div class="breadcrumb">
            ...
            <a class="btn btn-success pull-right mg-left" id="addDanhMucSP" href="/danhmuc/danh-muc-san-pham/input"><i class="fa fa-plus"></i> Thêm mới</a>
        </div>	
    </section>
    <!-- Main content -->
    <section class="content">
        <div class="box box-default">
            <?= Html::beginForm(['/danhmuc/danh-muc-san-pham/index'], 'post', ['id' => 'searchForm','name'=>'searchForm']) ?>
                                            ...
                                            foreach ($data as $item) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="" data-value="<?=$item["id"]?>">
                                                        <a href="<?= Url::to(['/danhmuc/danh-muc-san-pham/input','id'=>$item->id]) ?>">
                                                            <?php echo $item["name"]?>
                                                        </a>
                                                    </td>
                                                </tr>
...
<script type="text/javascript"> 
    function pageClick(page){
        document.searchForm.action = '/danhmuc/danh-muc-san-pham/index?page='+(page+1);
