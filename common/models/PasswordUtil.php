...
class PasswordUtil extends ActiveRecord implements IdentityInterface
{
    ...
    public static function create_hash($password)
    {
        ...
        return base64_encode("0".$salt_raw.$PBKDF2_Output);
    }
    ...
    public static function verify_password($password, $hash)
    {
		...
		$tempbyte = base64_decode($hash, true);

        $pbkdf2 = substr($tempbyte, 17);
        if ($pbkdf2 === false) {
            throw new Exception(
